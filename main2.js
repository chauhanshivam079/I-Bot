    ...
    let interval1 = setInterval(() => {
        ...
        try {
            ...
            let collection2 = mdClient
                ...
                .collection("whatsappSessionAuth");
            //(chatid,{})
            collection2.updateOne({ _id: 1 }, { $set: { sessionAuth: sessionDataAuth } });
                    ...
                    if (msg.hasOwnProperty("message")) {
                                ...
                                switch (msgData.cmd) {
                                    ...
                                    case "demote":
                                        ...
                                        if (await isAdminOrMember(chatId, botId, "isAdmin")) {
                                            ...
                                            await sock.sendMessage(
                                                chatId, { text: "Bot not an Admin" }, { quoted: m.messages[0] }
                                            );
                                        }
                                        break;
                                    case "link":
                                        if (await isAdminOrMember(chatId, botId, "isAdmin")) {
                                            ...
                                            await sock.sendMessage(
                                                chatId, { text: "Bot not an Admin!" }, { quoted: msg }
                                            );
                                        }
                                    ...
                                    case "help":
                                        await sock.sendMessage(
                                            chatId, { text: cmdList }, { quoted: msg }
                                        );
                                        break;
                                    case "toimg":
                                        if (msgData.isQuoted) {
                                            ...
                                            await sock.sendMessage(
                                                chatId, { text: "Tag a sticker!" }, { quoted: msg }
                                            );
                                        }
                                        break;
                                    case "iprof":
                                    ...
                                    case "tagall":
                                        if (await isAdminOrMember(chatId, senderId, "isAdmin")) {
                                            ...
                                            await sock.sendMessage(
                                                chatId, { text: "Admin only Command!" }, { quoted: msg }
                                            );
                                        }
                                    ...
                                    case "enable":
                                        if (
                                            ...
                                            if (
                                                ...
                                                if (val) {
                                                    await sock.sendMessage(
                                                        chatId, { text: "Command Enabled for this Group" }, { quoted: msg }
                                                    );
                                                } else {
                                                    await sock.sendMessage(
                                                        chatId, { text: `Couldn't enable Try Again Later!` }, { quoted: msg }
                                                    );
                                                }
                                            } else {
                                                await sock.sendMessage(
                                                    chatId, { text: "Wrong Command Entered!" }, { quoted: msg }
                                                );
                                            }
                                        } else {
                                            await sock.sendMessage(
                                                chatId, { text: "Admin/Bot Owner Only Command!" }, { quoted: msg }
                                            );
                                        }
                                        break;
                                    case "on":
                                    ...
                                    case "disable":
                                        if (
                                            ...
                                            if (
                                                ...
                                                if (val) {
                                                    await sock.sendMessage(
                                                        chatId, { text: "Command disable for this Group" }, { quoted: msg }
                                                    );
                                                } else {
                                                    await sock.sendMessage(
                                                        chatId, { text: `Couldn't disable Try Again Later!` }, { quoted: msg }
                                                    );
                                                }
                                            } else {
                                                await sock.sendMessage(
                                    ...
                                    case "add_ab":
                                        ...
                                        if (d) {
                                            ...
                                            await sock.sendMessage(
                                                chatId, { text: "Word added!" }, { quoted: msg }
                                            );
                                        } else {
                                            await sock.sendMessage(
                                    ...
                                    case "rem_ab":
                                        ...
                                        if (dd) {
                                            ...
                                            await sock.sendMessage(
                                                chatId, { text: "Word removed!" }, { quoted: msg }
                                            );
                                        } else {
                                            await sock.sendMessage(
                                                chatId, { text: "Some Error Occured" }, { quoted: msg }
                                    ...
                                    case "warn":
                                        if (
                                            ...
                                            if (tempId) {
                                                ...
                                                await sock.sendMessage(
                                                    chatId, { text: "No one tagged!" }, { quoted: msg }
                                                );
                                            }
                                        } else {
                                            await sock.sendMessage(
                                                chatId, { text: `Admin Only Command Cutie!` }, { quoted: msg }
                                            );
                                        }
                                        break;
                                    case ".":
                                    ...
                                    case "a":
                                        console.log("Hello");
                                        await sock.sendMessage(
                                            chatId, { text: "Yup! I am active" }, { quoted: msg }
                                        );
                                        break;
                                    case "makehimgay":
                                        if (msgData.isQuoted) {
                        ...
                        msgData.quotedMessage.participant.split("@")[0]
                                            ...
                                            if (
                                                ...
                                                await sock.sendMessage(
                                                    chatId, { text: "You are Gay!!" }, { quoted: msg }
                                                );
                                            }
                                        } else {
                                            await sock.sendMessage(
                                                chatId, { text: "Tag someone message" }, { quoted: msg }
                                            );
                                        }
                                        break;
                                }
                                if (
                                    ...
                                    if (tthUserDetail.has(senderId)) {
                                        ...
                                        await sock.sendMessage(
                                            chatId, { text: "You have not initiated the process\nSend #tth" }, { quoted: msg }
                                        );
                                    }
                                } else if (
                                    msgData.isQuoted &&
                                    ...
                                    if (tthUserDetail.has(senderId)) {
                                        ...
                                        try {
                                            await sock.sendMessage(
                                                chatId, { text: "Processing your file.....\nPlease wait!" }, { quoted: msg }
                                            );
                                ...
                                await sock.sendMessage(
                                    chatId, { text: "Command disabled for this Group!" }, { quoted: msg }
                                );
                            }
