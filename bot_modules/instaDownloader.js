            ...
            if(finalLink.indexOf("/p/")!==-1){
                let res=await fetch(finalLink,{
                    headers: {
                        ...
                        cookie: 'ig_did=2EA5DEE4-6678-4166-9A91-1B1B0F01A024; ig_nrcb=1; mid=YlgYsAALAAEUEhH5YOMjkGUQjULn; csrftoken=WtIrIYyki6fyDCRqBFTgDJDCiXNBC7NE; sessionid=52524028499%3Ah07GXAbGASLirM%3A1%3AAYd3_g-; ds_user_id=52524028499; fbm_124024574287414=base_domain.instagram.com;_js_datr="";datr=kPrrYsSSWrzd10EyB2s6H359;dpr=1.5 ; rur="ODN,52524028499,1693329037:01f7ba5e429" ',
                    },
                    referrerPolicy: "strict-origin-when-cross-origin",
                    body: null,
                    mode: "cors",
